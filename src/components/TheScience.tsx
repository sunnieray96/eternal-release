      ...
      <div className="max-w-7xl mx-auto px-8 md:px-16">
        <div className="flex flex-col md:flex-row gap-32 items-center">
          <div className="flex-1 space-y-16 text-left">
             <p className="text-[10px] uppercase tracking-[0.4em] font-bold text-black opacity-30 mb-8">The Architecture</p>
          ...
          <div className="flex-1">
             <div className="aspect-[3/4] bg-sand/10 rounded-[100px] border border-sand/20 overflow-hidden relative group">
                ...
                <div className="absolute inset-0 flex items-center justify-center p-24 pointer-events-none opacity-20 group-hover:opacity-40 transition-opacity">
                   <svg width="100%" height="100%" viewBox="0 0 200 200" fill="none" className="text-white">
