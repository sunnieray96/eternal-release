export default function Footer() {
  return (
    <footer id="contact" className="bg-[#1C1C1C] text-[#FCFAF7] py-24 relative overflow-hidden font-sans text-left">
      <div className="max-w-7xl mx-auto px-8 relative z-10">
        <div className="grid md:grid-cols-12 gap-24 items-start">
          <div className="md:col-span-7">
            <a href="/" className="font-serif text-4xl md:text-8xl font-medium tracking-tighter mb-16 block no-underline text-white">
               Eternal <span className="italic font-light text-[#D9D2C5]/30">Release</span>
            </a>
            <p className="text-[#FCFAF7]/20 text-xl font-light leading-relaxed max-w-md">
          ...
          <div className="md:col-span-5 space-y-24 text-right flex flex-col items-end">
             <div className="space-y-6">
                ...
                <a href="mailto:hello@eternalrelease.org" className="text-lg md:text-xl font-sans text-[#D9D2C5] hover:text-[#A8613F] transition-colors block no-underline opacity-60 hover:opacity-100">hello@eternalrelease.org</a>
             </div>
