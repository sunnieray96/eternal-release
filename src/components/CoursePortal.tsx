...
export default async function CoursePortal() {
  ...
  return (
    <section id="courses" className="py-32 md:py-56 bg-white/20 relative">
      <div className="editorial-container relative">
        ...
        <div className="grid md:grid-cols-3 gap-12">
          {!hasCourses ? (
            ...
            courses.map((course) => (
              <div key={course._id} className="wabi-border bg-white p-14 shadow-sm hover:shadow-xl transition-all duration-500">
...
function CoursePlaceholder({ title, level, price }: any) {
   return (
    <div className="wabi-border bg-white/40 p-14 opacity-70 group hover:bg-white transition-all">
