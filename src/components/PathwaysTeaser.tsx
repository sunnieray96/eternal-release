    ...
    <section id="courses" className="py-48 md:py-80 bg-white">
      <div className="max-w-7xl mx-auto px-8">
        <div className="text-center mb-40">
           <p className="text-[10px] uppercase tracking-[0.4em] font-bold text-[#1C1C1C]/30 mb-8">Offerings</p>
           <h2 className="font-serif text-5xl md:text-9xl font-light leading-tight">Pathways to Flow</h2>
        </div>
   ...
   return (
      <div className="text-center space-y-12 group pointer-events-none opacity-40">
         <div className="aspect-square rounded-full border border-[#D9D2C5]/30 flex items-center justify-center p-16 transition-all duration-1000">
            <div className="w-full h-full rounded-full border-[0.5px] border-[#1C1C1C]/5" />
         </div>
         <h3 className="font-serif text-3xl italic text-[#1C1C1C]">{title}</h3>
