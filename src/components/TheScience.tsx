export default function TheScience() {
  return (
    <section className="py-48 md:py-80 bg-[#F2EFE9] opacity-80">
      <div className="max-w-7xl mx-auto px-8 md:px-16">
        <div className="flex flex-col md:flex-row gap-32 items-center">
          <div className="flex-1">
             <div className="aspect-[3/4] bg-[#D4C5A9] opacity-10 rounded-[100px] border border-[#D4C5A9] flex items-center justify-center p-24 relative overflow-hidden">
          ...
          <div className="flex-1 space-y-16 text-left">
             ...
             <p className="text-2xl font-light text-black opacity-60 leading-relaxed max-w-lg">
