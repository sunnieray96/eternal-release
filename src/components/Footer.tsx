      ...
      <div className="max-w-7xl mx-auto px-8 relative z-10">
        <div className="grid md:grid-cols-12 gap-24 items-start mb-64">
          <div className="md:col-span-7">
            <a href="/" className="font-serif text-5xl md:text-7xl font-medium tracking-tighter mb-16 block no-underline text-white">
          ...
          <div className="md:col-span-5 space-y-20 text-right">
             <div className="space-y-6">
                ...
                <a href="mailto:hello@eternalrelease.org" className="text-3xl md:text-6xl font-serif italic text-[#D9D2C5] hover:text-[#A8613F] transition-colors block no-underline">hello@eternalrelease.org</a>
             </div>
             <div className="flex justify-end gap-16">
                <a href="https://instagram.com/eternal" className="text-[10px] font-bold uppercase tracking-[0.4em] text-[#FCFAF7]/40 hover:text-[#A8613F] transition-all no-underline">Instagram</a>
                <a href="/studio" className="text-[10px] font-bold uppercase tracking-[0.4em] text-[#FCFAF7]/40 hover:text-[#A8613F] transition-all no-underline">Dashboard</a>
             </div>
          </div>
        </div>
