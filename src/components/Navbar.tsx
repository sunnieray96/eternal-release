    ...
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-700 ${
      ...
      <div className="max-w-7xl mx-auto px-8 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-12">
          <Link href="/about" className="text-[10px] uppercase tracking-[0.4em] font-bold text-black/60 hover:text-[#A8613F] transition-colors">About</Link>
          <Link href="/#work" className="text-[10px] uppercase tracking-[0.4em] font-bold text-black/60 hover:text-[#A8613F] transition-colors">The Work</Link>
          <Link href="/#contact" className="text-[10px] uppercase tracking-[0.4em] font-bold text-black/60 hover:text-[#A8613F] transition-colors">Connect</Link>
        </div>
