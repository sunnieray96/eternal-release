    ...
    <main className="bg-[#FCFAF7] min-h-screen text-left">
      ...
      <section className="pt-64 pb-32 max-w-7xl mx-auto px-8 md:px-12">
        <div className="max-w-4xl">
           ...
           <div className="space-y-20 text-xl md:text-3xl font-light opacity-80 leading-relaxed">
              ...
              <div className="py-32 border-y border-[#D9D2C5]/40 my-32 text-center">
                 <p className="font-serif italic text-black text-4xl md:text-6xl leading-tight text-balance px-4">
              ...
              <div className="grid md:grid-cols-2 gap-20 my-32 items-center">
                 <div className="aspect-square bg-bone rounded-[100px] overflow-hidden border border-sand/30">
                    <img src="https://images.unsplash.com/photo-1544126592-807daa2b5d7a?q=80&w=1000" alt="Somatic Flow" className="w-full h-full object-cover opacity-60 grayscale" />
                 </div>
              ...
              <div className="pt-20 border-t border-sand/20 italic opacity-40 text-sm tracking-wide">
