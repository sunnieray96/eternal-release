      ...
      <section style={{ paddingTop: '16rem', paddingBottom: '12rem', maxWidth: '80rem', margin: '0 auto', paddingLeft: '2rem', paddingRight: '2rem' }}>
        <div style={{ maxWidth: '64rem' }}>
           ...
           <div style={{ display: 'flex', flexDirection: 'column', gap: '5rem', fontSize: 'clamp(1.2rem, 2.2vw, 1.8rem)', fontWeight: 300, color: 'rgba(28, 28, 28, 0.8)', lineHeight: 1.8 }}>
              ...
              <p>They practiced yoga to get out of my mind and into my body, but because I was stuck in a chronic &ldquo;fight-or-flight&rdquo; loop, they were making my stiffness and posture worse. I didn&apos;t realize I was &ldquo;bracing&rdquo; into the poses, reinforcing the fascia-armor my body had built to survive. I was trying to force peace onto a system that didn&apos;t yet feel safe.</p>
