export default function Footer() {
  return (
    <footer className="bg-[#1C1C1C] text-[#FCFAF7] py-24 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-8 relative z-10">
        <div className="grid md:grid-cols-12 gap-16">
          <div className="md:col-span-6">
            ...
            <p className="text-[#FCFAF7]/30 text-lg font-light leading-relaxed max-w-sm">
          ...
          <div className="md:col-span-6 space-y-12 text-right flex flex-col items-end">
             <div className="space-y-4">
                ...
                <a href="mailto:hello@eternalrelease.org" className="text-xl font-serif italic text-[#D9D2C5] hover:text-[#A8613F] transition-colors block no-underline">hello@eternalrelease.org</a>
             </div>
        ...
        <div className="mt-24 pt-10 border-t border-white/5">
           <div className="flex flex-col md:flex-row justify-between items-end gap-12">
              <p className="text-[9px] leading-[2.5] font-light uppercase tracking-[0.3em] text-[#FCFAF7]/20 max-w-4xl">
